 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   | Ctrl |  Alt | Play | Left | Right|                                       |  Up  | Down |   [  |   ]  | ~L1  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        |  =   | Lgui |       | Alt  |Web Back|
 *                                 ,------|------|------|       |------+--------+------.
 ...
 */
    ...
    //CJH NOTES TODO: AltShf is silly on the left side. LEFT and RIGHT on the tops don't make sense. Probably don't need the L1 key on the left side. Ctrl/Esc on right thumb cluster should be something else.
[BASE] = LAYOUT_ergodox_pretty(
  ...
  KC_LCTL,         KC_LALT,     KC_MPLY,       KC_LEFT, KC_RGHT,                                              KC_UP,   KC_DOWN, KC_LBRC, KC_RBRC, TT(SYMB),
                                                           KC_EQL,  KC_LGUI,              KC_LALT, KC_WBAK,
                                                                          KC_HOME,              KC_PGUP,
